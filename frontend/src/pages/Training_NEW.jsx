...
import { ArrowLeft, Upload, FileText, CheckCircle, XCircle, FileInput } from 'lucide-react';
      ...
      <div className=\"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8\">
        ...
        <div className=\"flex justify-end mb-6\">
          <Dialog open={showAdd} onOpenChange={setShowAdd}>
            <DialogTrigger asChild>
              <button data-testid=\"add-training-button\" className=\"btn-primary flex items-center gap-2\">
                <Upload size={18} />
                Add Training Data
              </button>
            </DialogTrigger>
                ...
                <TabsContent value=\"upload\">
                  <form onSubmit={handleUpload} className=\"space-y-4\">
                    <div>
                      ...
                      <select
                        data-testid=\"upload-doc-type-select\"
                        value={uploadData.doc_type}
                        onChange={(e) => setUploadData({ ...uploadData, doc_type: e.target.value })}
                        className=\"input-field\"
                      >
                        <option value=\"successful\">Successful Petition/Decision</option>
                        <option value=\"unsuccessful\">Unsuccessful Petition/Decision</option>
                      </select>
                    </div>
                    <div>
                      ...
                      >
                        ...
                        <option value=\"precedent_decision\">Precedent Decision (AAO/USCIS)</option>
                    ...
                    <div>
                      ...
                      <select
                        data-testid=\"upload-visa-type-select\"
                  ...
                  <form onSubmit={handlePaste} className=\"space-y-4\">
                    <div>
                      ...
                      <input
                        ...
                        className=\"input-field\"
                        placeholder=\"e.g., Matter of Dhanasar, Client X EB2-NIW Petition\"
                        required
                      />
                    </div>
                    <div>
        ...
        {loading ? (
          ...
          <div className=\"glass p-12 text-center\">
            ...
            <p className=\"text-gray-400 mb-4\">Add petitions and USCIS decisions to train the AI</p>
            <button
          ...
          <div className=\"space-y-6\">
            ...
            <div>
              <h3 className=\"text-xl font-bold mb-4 flex items-center gap-2\" style={{ fontFamily: 'Space Grotesk' }}>
                <CheckCircle className=\"text-green-500\" size={24} />
                Successful Petitions & Decisions
              </h3>
              <div className=\"space-y-3\">
                {successfulDocs.length === 0 ? (
                  <p className=\"text-gray-400 text-sm\">No successful documents yet</p>
                ) : (
            ...
            <div>
              <h3 className=\"text-xl font-bold mb-4 flex items-center gap-2\" style={{ fontFamily: 'Space Grotesk' }}>
                <XCircle className=\"text-red-500\" size={24} />
                Unsuccessful Petitions & Decisions
              </h3>
              <div className=\"space-y-3\">
                {unsuccessfulDocs.length === 0 ? (
                  <p className=\"text-gray-400 text-sm\">No unsuccessful documents yet</p>
                ) : (
